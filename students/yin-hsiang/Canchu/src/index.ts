...
import { genCursor as genChatHistoryCursor, chatHistory } from './chat/history.js';
// database
...
app.get(`/api/${env.apiVer}/chat/:user_id/messages`, [accessToken, userExist, genChatHistoryCursor], chatHistory);
